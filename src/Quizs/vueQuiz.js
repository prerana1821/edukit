...
export default function VueQuiz() {
    const questions = [
        {
            questionText: 'Which data binding interpolation is also known as “Mustache” syntax?',
            answerOptions: [
        ...
        {
            questionText: 'Once a View Model is lost, all the event listeners are automatically removed.',
            answerOptions: [
        ...
        },
        {
            ...
            answerOptions: [
                { answerText: 'var text = new object ({//options}).', isCorrect: false },
        ...
        {
            questionText: 'Which event modifier is used for only prevent clicks on the element itself?',
            answerOptions: [
        ...
        {
            questionText: 'The updated hook is terminated after modifications have been written to the DOM',
            answerOptions: [
